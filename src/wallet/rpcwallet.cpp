...
UniValue getnewaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "\nReturns a new MicroBitcoin address for receiving payments.\n"
...
UniValue getrawchangeaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 1)
        throw std::runtime_error(
            ...
            "\nReturns a new MicroBitcoin address, for receiving change.\n"
...
UniValue sendtoaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 8)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("sendtoaddress", "\"Boti3Va6ShEB5nsYd4RKotucpXkaqZzaQr\" 0.1")
            + HelpExampleCli("sendtoaddress", "\"Boti3Va6ShEB5nsYd4RKotucpXkaqZzaQr\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("sendtoaddress", "\"Boti3Va6ShEB5nsYd4RKotucpXkaqZzaQr\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("sendtoaddress", "\"Boti3Va6ShEB5nsYd4RKotucpXkaqZzaQr\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue sendfrom(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 3 || request.params.size() > 6)
        throw std::runtime_error(
            ...
            + HelpExampleCli("sendfrom", "\"\" \"Boti3Va6ShEB5nsYd4RKotucpXkaqZzaQr\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n"
            + HelpExampleCli("sendfrom", "\"tabby\" \"Boti3Va6ShEB5nsYd4RKotucpXkaqZzaQr\" 0.01 6 \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendfrom", "\"tabby\", \"Boti3Va6ShEB5nsYd4RKotucpXkaqZzaQr\", 0.01, 6, \"donation\", \"seans outpost\"")
        );
...
UniValue sendmany(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 8)
        throw std::runtime_error(
            ...
            + HelpExampleCli("sendmany", "\"\" \"{\\\"1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\\\":0.01,\\\"BVrjVgyd13VwKWXjkYLm8XopcmqrKCS15X\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmany", "\"\" \"{\\\"1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\\\":0.01,\\\"BVrjVgyd13VwKWXjkYLm8XopcmqrKCS15X\\\":0.02}\" 6 \"testing\"") +
            "\nSend two amounts to two different addresses, subtract fee from amount:\n"
            + HelpExampleCli("sendmany", "\"\" \"{\\\"1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\\\":0.01,\\\"BVrjVgyd13VwKWXjkYLm8XopcmqrKCS15X\\\":0.02}\" 1 \"\" \"[\\\"1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\\\",\\\"BVrjVgyd13VwKWXjkYLm8XopcmqrKCS15X\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmany", "\"\", \"{\\\"1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\\\":0.01,\\\"BVrjVgyd13VwKWXjkYLm8XopcmqrKCS15X\\\":0.02}\", 6, \"testing\"")
        );
    ...
    for (const std::string& name_ : keys) {
        ...
        if (!IsValidDestination(dest)) {
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid MicroBitcoin address: ") + name_);
        }
...
UniValue addmultisigaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3)
    {
        std::string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" )\n"
            ...
            "Each key is a MicroBitcoin address or hex-encoded public key.\n"
...
UniValue walletlock(const JSONRPCRequest& request)
{
    ...
    if (pwallet->IsCrypted() && (request.fHelp || request.params.size() != 0)) {
        throw std::runtime_error(
            ...
            + HelpExampleCli("sendtoaddress", "\"Boti3Va6ShEB5nsYd4RKotucpXkaqZzaQr\" 1.0") +
