...
BOOST_AUTO_TEST_CASE(MempoolSizeLimitTest)
{
    ...
    BOOST_CHECK_EQUAL(pool.GetMinFee(100).GetFeePerK(), maxFeeRateRemoved.GetFeePerK() + 1000);
    ...
    BOOST_CHECK_EQUAL(pool.GetMinFee(100).GetFeePerK(), llround((maxFeeRateRemoved.GetFeePerK() + 1000)/2.0));
    ...
    BOOST_CHECK_EQUAL(pool.GetMinFee(100).GetFeePerK(), 1000);
